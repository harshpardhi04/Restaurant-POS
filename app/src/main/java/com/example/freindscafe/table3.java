...
public class table3 extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        SQLiteDatabase db = getApplicationContext().openOrCreateDatabase("my_db3", MODE_PRIVATE, null);
            String sql = "CREATE TABLE IF NOT EXISTS myfood3 ( id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT, qty INTEGER, price REAL)";
            db.execSQL(sql);
        Cursor cursor=db.rawQuery("SELECT COUNT(*) FROM myfood3", null);
    ...
    private ArrayList<TableRow> loaddata() {
        SQLiteDatabase db = getApplicationContext().openOrCreateDatabase("my_db3", MODE_PRIVATE, null);
        // Get the data
        Cursor cursor = db.rawQuery("SELECT * FROM myfood3", null);
        ...
        arr.add("Donuts");
            ...
            toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    if (position == R.id.print) {
                        ...
                        {
                            Toast.makeText(table3.this, "Printer is Not Connected", Toast.LENGTH_SHORT).show();

                        }else {
                            Toast.makeText(table3.this, "Loading...", Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                ...
                                Toast.makeText(table3.this, "Unable To Connect", Toast.LENGTH_SHORT).show();
                            }
                        }
                      ...
                      tableLayout.removeViews(1,row-1);
                        SQLiteDatabase db = getApplicationContext().openOrCreateDatabase("my_db3", MODE_PRIVATE, null);
                        db.execSQL("DELETE FROM myfood3");
                        db.close();
                        money.setText("Rs. 0");
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(table3.this);
                                ...
                                call.enqueue(new Callback() {
                                    ...
                                    public void onFailure(@NonNull Call call, @NonNull IOException e) {
                                        runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(table3.this, "Error Occured", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }
                                    ...
                                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                                        if (response.isSuccessful()) {
                                            runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    Toast.makeText(table3.this, "Data Sent Successfully", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                        } else {
                                            runOnUiThread(new Runnable() {
                        ...
                        builder.show();
                                ...
                                Toast.makeText(table3.this, "Sorry", Toast.LENGTH_SHORT).show();
                            }
            ...
            add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(table3.this, android.R.layout.simple_list_item_1, arr);
                    atx.setAdapter(adapter);


                    AlertDialog.Builder builder = new AlertDialog.Builder(table3.this);
                    builder.setTitle("Table-3 Add FoodItem");
                    ...
                    builder.setPositiveButton("Add", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(foodName.isEmpty() && foodPrice.isEmpty() && foodQty.isEmpty())
                            {
                                ...
                                foodPrice=" ";
                                foodQty= " ";
                                Toast.makeText(table3.this,"Please Enter Food Price and Food Quantity",Toast.LENGTH_SHORT).show();
                                ...
                                try {
                                    ...
                                    Toast.makeText(table3.this, "Please enter a valid food name", Toast.LENGTH_SHORT).show();
                                }

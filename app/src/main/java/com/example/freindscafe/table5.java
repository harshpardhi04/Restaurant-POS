...
public class table5 extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        SQLiteDatabase db = getApplicationContext().openOrCreateDatabase("my_db5", MODE_PRIVATE, null);
            String sql = "CREATE TABLE IF NOT EXISTS myfood5 ( id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT, qty INTEGER, price REAL)";
            db.execSQL(sql);
        Cursor cursor=db.rawQuery("SELECT COUNT(*) FROM myfood5", null);
    ...
    private ArrayList<TableRow> loaddata() {
        SQLiteDatabase db = getApplicationContext().openOrCreateDatabase("my_db5", MODE_PRIVATE, null);
        // Get the data
        Cursor cursor = db.rawQuery("SELECT * FROM myfood5", null);
        ...
        arr.add("Donuts");
            ...
            toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    ...
                    if (position == R.id.print) {
                        ...
                        {
                            Toast.makeText(table5.this, "Printer is Not Connected", Toast.LENGTH_SHORT).show();

                        }else {
                            Toast.makeText(table5.this, "Loading...", Toast.LENGTH_SHORT).show();
                            ...
                            try {
                                ...
                                Toast.makeText(table5.this, "Unable To Connect", Toast.LENGTH_SHORT).show();
                            }
                        }
                      ...
                      tableLayout.removeViews(1,row-1);
                        SQLiteDatabase db = getApplicationContext().openOrCreateDatabase("my_db5", MODE_PRIVATE, null);
                        db.execSQL("DELETE FROM myfood5");
                        db.close();
                        money.setText("Rs. 0");
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(table5.this);
                        ...
                        builder.setPositiveButton("Add", new DialogInterface.OnClickListener() {
                            ...
                            private void savedmydata(String getname,String getmob,Double totalFoodPrice,String formattedDate,String gettable ) {
                                String url = "Your WebApp URL Here";
                                ...
                                call.enqueue(new Callback() {
                                    ...
                                    public void onFailure(@NonNull Call call, @NonNull IOException e) {
                                        runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(table5.this, "Error Occured", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }
                                    ...
                                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                                        if (response.isSuccessful()) {
                                            runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    Toast.makeText(table5.this, "Data Sent Successfully", Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                        } else {
                                            runOnUiThread(new Runnable() {
                        ...
                        builder.show();
                                ...
                                Toast.makeText(table5.this, "Sorry", Toast.LENGTH_SHORT).show();
                            }
            ...
            add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(table5.this, android.R.layout.simple_list_item_1, arr);
                    atx.setAdapter(adapter);


                    AlertDialog.Builder builder = new AlertDialog.Builder(table5.this);
                    builder.setTitle("Table-5 Add FoodItem");
                    ...
                    builder.setPositiveButton("Add", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(foodName.isEmpty() && foodPrice.isEmpty() && foodQty.isEmpty())
                            {
                                ...
                                foodPrice=" ";
                                foodQty= " ";
                                Toast.makeText(table5.this,"Please Enter Food Price and Food Quantity",Toast.LENGTH_SHORT).show();
                                ...
                                try {
                                    ...
                                    Toast.makeText(table5.this, "Please enter a valid food name", Toast.LENGTH_SHORT).show();
                                }
